...
<div class="w-full grid place-content-center">
  <article class="prose dark:prose-invert max-w-[650px] prose-code:before:hidden prose-code:after:hidden">
    ...
    <p>
      ...
      low-level development, in such languages as <code>Python</code>,
      <code>Javascript</code>, <code>Typescript</code>
      and <code>C</code>. Check out my <a class="anchor"
      href="/portfolio">portfolio</a> to get a taste of what I do!
    </p>
    <p>
      Much of my previous work laid in web development, but I'm
      looking to sharpen my skills in systems programming, data
      science, and machine learning.
    </p>
    <p>
      I'm always excited for new opportunities to learn, grow, and
      best of all, build. Refer to my social profiles
      linked <a class="anchor" href="/">here</a>, and let's connect!
    </p>
  </article>
</div>
